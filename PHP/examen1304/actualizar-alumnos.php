...
if (isset($_REQUEST['enviar'])) {
    ...
    $sentenciaSQL = "UPDATE alumnos SET nombre = ?, 
                    fechanac = ?, pagado = ?, importe = ? WHERE nif = ? "; // es el pk
...
<body>
    ...
    ?>
        ...
        <form action="#" method="post" class="m-3 shadow-lg">
            ...
            <input type="number" name="importe" id="importe"
                ...
                value="<?php echo $alumno['Precio']; ?>"><br>
    ...
    <section class="row">
        <nav class="col">
            <a href="cargar.php"
                class="btn btn-sm btn-success w-100">Cargar BBD</a>

            <a href="insertar-docentes.php"
                class="btn btn-sm btn-warning w-100">Insertar Docente</a>

            <a href="insertar-alumnos.php"
                class="btn btn-sm btn-warning w-100">Insertar Alumno</a>
        </nav>
        <nav class="col">
