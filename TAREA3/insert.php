<!-- http://localhost/Curso/tarea3/insert.php -->
...
if (isset($_POST['enviar'])) {
    ...
    $sentenciaSQL = "INSERT INTO usuarios 
                     (email, password, nombre, apellido, apellidos, autonomo, nif_cif)
                    VALUES (?,?,?,?,?,?,?)";
    $sentenciaPreparada = $conexion->prepare($sentenciaSQL);
    // Encriptamos la sentencia (bind_param)
    $sentenciaPreparada->bind_param("isdis", $email, $password, $nombre, $apellido, apellidos, autonomo, nif_cif);
